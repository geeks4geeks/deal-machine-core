...
class OwnerStateFilter extends Component {
  ...
  render(){
    ...
    return <SelectFilter
            filter_title="Owner Address State"
            filter_options={this.state.options}
            filter_value={this.props.filters.filter_owner_state}
            filter_prop={"filter_owner_state"}
...
export default connect(mapStateToProps, {})(OwnerStateFilter);
