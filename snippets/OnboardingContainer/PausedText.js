...
class CanceledText extends Component {
  ...
  render() {
    ...
    if(this.props.plan_module_info.paused == 1 &&
      ...
      return(
        ...
        >
          ...
          <Wrapper style={{
            ...
            {this.props.onboarding_info.pausedTitle}
            </Title>
            <Copy style={{textAlign: this.props.isCard ? "left" : "center"}}>{this.props.onboarding_info.pausedText}</Copy>
          </Wrapper>
          <PillButton primary={true} style={{margin: 0}} onPress={()=>{
            ...
            {this.props.onboarding_info.pausedButtonText}
          </PillButton>
        </Wrapper>
      )
    }
